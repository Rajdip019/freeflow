...
export function FeedbackContextProvider({ children }: any) {
    ...
    const [imageData, setImageData] = useState<IReviewImageData | undefined>(defaultValues.imageData);
    ...
    const [highlightedComment, setHighlightedComment] = useState<IReview>(defaultValues.highlightedComment as IReview);
    const [isCompareView, setIsCompareView] = useState<boolean>(defaultValues.isCompareView);
    const [isFocusedThread, setIsFocusedThread] = useState<boolean>(defaultValues.isFocusedThread);
    ...
    const value = { imageData, threads, version, isAdmin, uname, highlightedComment, setHighlightedComment, isCompareView, setIsCompareView, setVersion, isFocusedThread, setIsFocusedThread }
