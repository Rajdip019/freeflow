...
const ImageUploadModal = () => {
    ...
    const uploadFile = () => {
        ...
        return (
            <>
                <button onClick={() => { onOpen(); clearFile(); setUploadingState("not-started") }} className=" font-semibold font-sec btn-p rounded flex items-center gap-3 px-1 md:px-6 py-1 md:py-3">
                    <svg
                        fill="currentColor"
                        className="w-8 md-w-6 text-white"
                        viewBox="0 0 24 24"
