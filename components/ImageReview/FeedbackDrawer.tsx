                    ...
                    >
                        ...
                        <div>
                            {isFocusedThread ? (
                                ...
                                <>
                                    <div className=" sticky -top-[0.3rem] z-50 flex py-2 ml-4 bg-sec flex-col">
                                        <div className=" flex gap-3">
                                            <Typography.Title level={5} className="font-sec font-semibold">
                                                Feedbacks
                                            </Typography.Title>
                                    ...
                                    {threads.length > 0 ? (
                                                        ...
                                                        {thread.imageURL ? (
                                                            ...
                                                            <div className=" mt-5 px-2 text-center font-semibold">
                                                                <Typography.Paragraph>
                                                                    ...
                                                                    Please switch to new version by uploading the image
                                                                    again.
                                                                </Typography.Paragraph>
                                                            </div>
                                                        )}
                                        ...
                                        <div className="mt-32 flex flex-col justify-center">
                                            <div className="p-4 text-center">
                                                ...
                                                <Typography.Text className=" font-sec">No Comments yet</Typography.Text>
